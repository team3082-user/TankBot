...
public class Robot extends TimedRobot {
  ...
  public void robotInit() {
    ...
    //needs ids
    Control.DriveTrainLeft0 = new VictorSPX(0);
    Control.DriveTrainLeft1 = new VictorSPX(6);

    Control.DriveTrainLeft1.setInverted(true);
    Control.DriveTrainLeft0.setInverted(true);

    Control.DriveTrainRight0 = new VictorSPX(5);
    Control.DriveTrainRight1 = new VictorSPX(1);
